...
namespace hrms_min_ASP_Net_Core_Project.Controllers
{
    public class AttendancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,AttendanceDate,IsPresent,Remarks")] Attendance attendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,AttendanceDate,IsPresent,Remarks")] Attendance attendance)
        {
            if (id != attendance.Id)
            {
                return NotFound();
